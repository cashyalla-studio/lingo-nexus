...
class PrivacyScreen extends StatelessWidget {
  ...
  List<(String, String)> _sections(AppLocalizations l10n) => [
    (l10n.privacySec1Title, l10n.privacySec1Body),
    (l10n.privacySec2Title, l10n.privacySec2Body),
    (l10n.privacySec3Title, l10n.privacySec3Body),
    (l10n.privacySec4Title, l10n.privacySec4Body),
    (l10n.privacySec5Title, l10n.privacySec5Body),
  ];
}
